...
import com.umeshghimire.commons.models.*
import com.umeshghimire.commons.views.MyTextView
...
fun Activity.openPathIntent(path: String, forceChooser: Boolean, applicationId: String, forceMimeType: String = "", extras: HashMap<String, Boolean> = HashMap()) {
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.umeshghimire.gallery.pro" || applicationId == "com.umeshghimire.gallery.pro.debug") {
