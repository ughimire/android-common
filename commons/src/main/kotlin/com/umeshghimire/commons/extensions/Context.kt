...
import com.umeshghimire.commons.helpers.*
import com.umeshghimire.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.umeshghimire.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.umeshghimire.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.umeshghimire.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.umeshghimire.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.umeshghimire.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.umeshghimire.commons.models.AlarmSound
import com.umeshghimire.commons.models.BlockedNumber
import com.umeshghimire.commons.models.SharedTheme
import com.umeshghimire.commons.views.*
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.umeshghimire.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.umeshghimire.thankyou")

fun Context.isAProApp() = packageName.startsWith("com.umeshghimire.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.umeshghimire."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.umeshghimire.contacts") && !packageName.startsWith("com.umeshghimire.dialer")) {
        true
    } else if ((packageName.startsWith("com.umeshghimire.contacts") || packageName.startsWith("com.umeshghimire.dialer")) && isQPlus()) {
