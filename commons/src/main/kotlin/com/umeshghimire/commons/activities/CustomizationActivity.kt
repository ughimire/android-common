...
import com.umeshghimire.commons.dialogs.*
import com.umeshghimire.commons.extensions.*
import com.umeshghimire.commons.helpers.*
import com.umeshghimire.commons.models.MyTheme
import com.umeshghimire.commons.models.RadioItem
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.umeshghimire.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
