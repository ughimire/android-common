package com.umeshghimire.commons.activities
...
import com.umeshghimire.commons.asynctasks.CopyMoveTask
import com.umeshghimire.commons.dialogs.ConfirmationDialog
import com.umeshghimire.commons.dialogs.ExportSettingsDialog
import com.umeshghimire.commons.dialogs.FileConflictDialog
import com.umeshghimire.commons.dialogs.WritePermissionDialog
import com.umeshghimire.commons.extensions.*
import com.umeshghimire.commons.helpers.*
import com.umeshghimire.commons.interfaces.CopyMoveListener
import com.umeshghimire.commons.models.FAQItem
import com.umeshghimire.commons.models.FileDirItem
import java.io.File
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.umeshghimire")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.umeshghimire.")
